export default[
    ...
    {
        title:'Stable Buddy',
        imgUrl:'/assets/stability.png',
        stack:['Python','Pytorch','Transformers','GPU','Stable-Diffusion'],
        link:'https://github.com/Hrishabh-V/Stable-Buddy.git',
        liveLink:'https://huggingface.co/spaces/CHEONMA010/StableBuddy',
    },


    {
        title:'ESRGAN Upscaling',
        imgUrl:'/assets/esrgan.jpg',
        stack:['Python','Pytorch','Flask','GPU','Pre-trained models'],
